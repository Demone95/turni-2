...
function shift(d){if(d.getDay()===0||d.getDay()===6)return 0;let ref=savedRef?new Date(savedRef+'T12:00:00'):monday(new Date()),w=Math.round((monday(d)-monday(ref))/604800000),idx=cycle.indexOf(baseShift);return cycle[((idx+w)%2+2)%2]}
